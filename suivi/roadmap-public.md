...
- **Menu Sécurité en onglets** (Synthèse, Vulnérabilités, Bans, Menaces, Sentinel, En-têtes & certificats) et page **Vulnérabilités** en vue Parc / Liste avec tiroir de détail, identique pour l’Admin et les passerelles, adaptée au mobile
